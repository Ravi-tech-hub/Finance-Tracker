  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-green-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        <div className="w-48 h-48 rounded-[40px] bg-green-600 absolute  rounded-4 -top-7 -left-5" />
        <div className="w-48 h-56  rounded-[40px] border-[20px] border-green-500 absolute top-[30%] -right-10" />
        <div className="w-48 h-56 rounded-[40px] bg-green-500 absolute -bottom-7 -left-5" />

        <div className="grid grid-cols-1 z-20">
          <StatsInfoCard
            icon={<LuTrendingDown />}
            label="Track your Income and Expeses"
            value="43000"
            color="bg-green-500"
          />
        </div>
